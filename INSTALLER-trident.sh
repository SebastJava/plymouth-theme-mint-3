...
sudo mkdir -p /usr/share/plymouth/themes && sudo cp -rf mint-logo-trident /usr/share/plymouth/themes
echo
echo "This will take a few seconds."
echo "DO NOT QUIT until you are invited to do so..."
echo
sudo update-alternatives --install /usr/share/plymouth/themes/default.plymouth default.plymouth /usr/share/plymouth/themes/mint-logo-trident/mint-logo-trident.plymouth 200 &&
sudo update-alternatives --set default.plymouth /usr/share/plymouth/themes/mint-logo-trident/mint-logo-trident.plymouth &&
